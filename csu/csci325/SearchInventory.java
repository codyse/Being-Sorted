...
public class SearchInventory {
	...
	public static int[] searchByName(String search, Inventory inventory) {
		...
		// Loops through each item in the ArrayList items. If the name matches the
		// search parameter it
	...
	// only use this if you want to search description without searching by name;
	// otherwise use completeSearch.
	...
	public static int[] completeSearch(String search, Inventory inventory) {
		...
		int[] mergedArray = IntStream.concat(IntStream.of(nameMatch), IntStream.of(descriptionMatch)).distinct()
				.sorted().toArray();
